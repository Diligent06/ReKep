...
def solve_ik(ik_solver, action):
    ...
    iter, error, target_qpos = ik_solver.solve(action, iter_flag=True)

    return iter, error, target_qpos

from transforms3d.quaternions import mat2quat, quat2mat

def transform_goal_to_wrt_base(goal_pose, base_pose=np.array([-6.1500001e-01, 7.2759576e-11, -1.4901161e-08, 
